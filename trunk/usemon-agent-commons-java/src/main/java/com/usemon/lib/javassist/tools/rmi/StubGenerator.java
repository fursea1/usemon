...
package com.usemon.lib.javassist.tools.rmi;
...
public class StubGenerator implements Translator {
     ...
     *
     * @see com.usemon.lib.javassist.Translator#start(ClassPool)
     */
     ...
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see com.usemon.lib.javassist.Translator#onLoad(ClassPool,String)
     */
