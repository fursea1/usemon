 ...
 *
 * @see com.usemon.lib.javassist.CtClass
 * @see com.usemon.lib.javassist.ClassPath
 */
public class ClassPool {
     ...
     * @see com.usemon.lib.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see com.usemon.lib.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see com.usemon.lib.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     *                          the same name.
     * @see com.usemon.lib.javassist.ByteArrayClassPath
     */
     ...
     * @see com.usemon.lib.javassist.ClassPath
     * @see com.usemon.lib.javassist.URLClassPath
     * @see com.usemon.lib.javassist.ByteArrayClassPath
     */
