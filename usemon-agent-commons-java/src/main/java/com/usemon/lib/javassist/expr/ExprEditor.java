 ...
 *
 * @see com.usemon.lib.javassist.CtClass#instrument(ExprEditor)
 * @see com.usemon.lib.javassist.CtMethod#instrument(ExprEditor)
 * @see com.usemon.lib.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
